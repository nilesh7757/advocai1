...
urlpatterns = [
    ...
    path('conversations/<str:pk>/signatures/', views.manage_signatures, name='manage-signatures'),
    path('conversations/<str:pk>/save-as-template/', views.save_as_template, name='save-as-template'),
